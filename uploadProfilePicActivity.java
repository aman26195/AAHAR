...
public class uploadProfilePicActivity extends AppCompatActivity {
    ...
    private void uploadPic() {
        if(uriImage!=null)
        {
            String imageName = "display_pic.jpg";
            ...
            fileReference.putFile(uriImage).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    fileReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            if(uri != null){
                                ...
                                Toast.makeText(uploadProfilePicActivity.this, "Path Not Found", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
                ...
                public void onFailure(@NonNull Exception e) {
                    progressBar.setVisibility(View.GONE);
                    Toast.makeText(uploadProfilePicActivity.this, e.getMessage()+uriImage, Toast.LENGTH_LONG).show();
